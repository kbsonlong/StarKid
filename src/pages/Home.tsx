...
export function Home() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-8">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-sm text-gray-500 mb-1">家庭总积分</div>
            <div className={`text-3xl font-bold ${getPointsColor(totalPoints)}`}>
              {totalPoints}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {quickActions.map((action) => {
            ...
            return (
              ...
              >
                <div className={`inline-flex p-3 rounded-lg ${action.color} ${action.hoverColor} transition-colors group-hover:scale-110 transform duration-200`}>
      ...
      {children.length > 0 && (
        <div>
          <h2 className="text-xl font-semibold text-gray-800 mb-6">儿童积分概览</h2>
      ...
      {recentBehaviors.length > 0 && (
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-gray-800">最近行为记录</h2>
            <Link
              to="/behaviors"
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            <div className="divide-y divide-gray-100">
              {recentBehaviors.map((behavior) => (
                <div key={behavior.id} className="p-4 flex items-center justify-between">
